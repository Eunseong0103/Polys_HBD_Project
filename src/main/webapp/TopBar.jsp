...
<body>
  ...
  <div id="top_container" class="#">
    <div id="wrap_content" class="row">
      <div id="title" class="col-sm-4">
        생활관 통합 정보 시스템 <a style="color: rgb(252, 180, 22);" href="Index.jsp">[한반도]</a>
      </div>
      ...
      <div id="user_data" class="col-sm-3">
        ...
        <a style="font-weight: bold;"></a><%=id %> 님 [백두관 사생회]
      </div>
  ...
  <nav id="menubar">
    <ul id="menuItem">
      <li><a href="NotieMain.jsp">공지</a></li>
      <li><a href="MyPenalty.jsp">벌점</a></li>
      <li><a href="ApplyList.jsp">외박</a></li>
      <li><a href="PersonalData0.jsp">환경기록카드</a></li>
